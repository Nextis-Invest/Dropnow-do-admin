...
import { EditClientDialogTabs } from "@/components/clients/edit-client-dialog-tabs";
      ...
      try {
        ...
        if (response.ok) {
          ...
          const primaryContact =
            data.users && data.users.length > 0 ? data.users[0] : null;
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <Badge
                              variant={
                                client.active ? "success" : "destructive"
                              }
                              className={
                                client.active
                      ...
                      <CardContent>
                        {client.bookings && client.bookings.length > 0 ? (
                          ...
                          <div className="text-center py-8">
                            ...
                            <p className="text-muted-foreground mb-4">
                              This client doesn't have any bookings yet.
                            </p>
          ...
          const fetchClientDetails = async () => {
            try {
              ...
              if (response.ok) {
                ...
                const error = await response.json();
                toast.error(
                  error.error || "Failed to fetch updated client details"
                );
              }
            } catch (error) {
              console.error("Error fetching updated client details:", error);
              toast.error("An error occurred while refreshing client details");
            }
          };
          fetchClientDetails();
        }}
